...
//   date: 2013
//-----------------------------------------------------------------------------
#ifndef __MCD_THEREMAX_AUDIO_H__
#define __MCD_THEREMAX_AUDIO_H__

#include "theremax-def.h"
...
typedef void (* TheremaxAudioCallback)( SAMPLE * buffer, unsigned int numFrames, void * userData );
...
//-----------------------------------------------------------------------------
// name: TheremaxAudioIO
// desc: static audio I/O
//-----------------------------------------------------------------------------
class TheremaxAudioIO
{
public:
...
protected:
    ...
    static TheremaxAudioCallback o_callback;
